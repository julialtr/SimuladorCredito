...
export default function InputSwitchTema({
  ...
  useEffect(() => {
    handleUpdate(darkMode);
  }, [darkMode, handleUpdate]);
  ...
  return (
    <div className="input-switch">
      <input
        type="checkbox"
        id="toggle"
        className="input-switch-checkbox"
        checked={darkMode}
        onChange={handleChange}
      />
      <div className="input-switch-container">
        <label htmlFor="toggle" className="input-switch-label">
          <div className="input-switch-circle">
            <svg
              className="sun"
